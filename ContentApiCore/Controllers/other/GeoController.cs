...
{    
    ...
    {
        public GeoController(IWebHostEnvironment env, ISettings settings, ILogger<GeoController> logger, QueryFactory queryFactory, IOdhPushNotifier odhpushnotifier)
