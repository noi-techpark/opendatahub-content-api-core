...
using ContentApiCoreTests.IntegrationTests;
using System;
...
namespace ContentApiCoreTests.IntegrationTests
{
    ...
    public class FilterTests : IClassFixture<CustomWebApplicationFactory<ContentApiCore.Startup>>

    {
        private readonly HttpClient _client;
        private readonly CustomWebApplicationFactory<ContentApiCore.Startup> _factory;

        public FilterTests(CustomWebApplicationFactory<ContentApiCore.Startup> factory)
        {
            _factory = factory;
        ...
        {
            var url = "/v1/Example?pagesize=20&pagenumber=1&fields=Detail.de.Title,Features[*].Name,HgvId,Test";
